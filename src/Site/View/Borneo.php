            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 animated slideInLeft" id="aside-left">
                        ...
                        <h2>Les sites de Kalaweit à Bornéo</h2>
                        <br>

                        <h3>Le bureau</h3>

                        <p>Il est situé dans la ville de Palangkaraya, capitale de la région du Kalimantan Centre. C’est là que se trouve l’équipe administrative et où sont accueillis les gibbons avant l’envoi au Gibbon Conservation Center.
                        </p>


                        <h3>La radio Kalaweit FM</h3>

                        <p>Créée en 2003, elle se trouve à Palangkaraya. Elle a pour objectif de sensibiliser la population locale à la préservation de l’environnement tout en restant attractive et musicale. Près de 15 000 personnes écoutent chaque jour Kalaweit FM. L'âge moyen des auditeurs va de 15 à 25 ans.
                        </p>
                        <p>
                        ...
                        <h3>La réserve Dulan</h3>
                        <p>
                            La réserve Dulan fait 187,8 hectares et se trouve dans le Kalimantan centre. Elle est située dans une zone de forêt de 1 500 hectares que Kalaweit souhaite acquérir et protéger. Cette forêt est un refuge pour les animaux, notamment pour une centaine d'orang outans ayant fuit la déforestation. L'extrême richesse de la forêt, mosaïque de forêt primaire et secondaire ancienne, permet d'abriter un grand nombre d'individus de chaque espèce comme des gibbons (environ 200 individus), 2 espèces de langurs, des ours des cocotiers, des panthères nébuleuses, 2 espèces de macaques, des cerfs sambars, des muntjacs etc.
                        </p>
                        <p>
                            La population vivant à proximité de cette zone de forêt dépend étroitement du lac qui est au sein de la réserve et les villageois vont nous aider dans le surveillance de la zone. Ils pourront toujours y pénétrer pour s'adonner à leurs activités traditionnelles comme la collecte du rotin ou la pêche.
                        </p>


                        <h3>Le gibbon conservation center de Pararawen</h3>

                        <p>Il s’étend sur 8 hectares qui appartiennent à Kalaweit, et est face à la réserve du même nom. Ce centre est à proximité de la ville de Muara Teweh, à environ 350 km au nord de Palangkaraya. Il est composé de trois camps pour l'accueil du personnel, d'un bâtiment de stockage pour la nourriture des animaux, d'une clinique et d'une nurserie dans lesquelles exercent trois vétérinaires à temps plein.
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <h3>La Kalaweit Pararawen réserve</h3>
                            <p>
                                Elle se situe à 7 heures de route de Palangkaraya, et à 40 minutes de bateau de Muara Teweh, la ville la plus proche.
                            </p>
                            <p>
                                Cette réserve de 288,10 hectares est l'habitat de 2 groupes de nasiques, une trentaine d'individus, et est limitrophe au centre de Pararawen où sont les animaux recueillis. Elle est située dans le Central Kalimantan, district de barito Utara (Lemo).
                            </p>
                            <p>
                                Cette zone protégée se compose de 2 réserves : 1) La réserve “Fondation Brigitte Bardot" (en bleu), en hommage à cette fondation et à son soutien, en particulier son aide pour protéger plus de 80 hectares de forêt- en cours de réalisation- ; 2) La réserve "des amis de Kalaweit" (en jaune). Ces deux réserves continuent de s'agrandir d'année en année.
                            </p>
                            <p>
                            ...
                            <p>
                                <h3>La Mangkolisoi réserve</h3>
                                <p>
                                    Sa création date d'avril 2017, elle fait 16 hectares. Cette forêt est l'habitat de gibbons, ours malais, orang outans etc.. Cette zone protégée de trouve dans la province centrale de Kalimantan, district de Murung Raya dans le canton de Siang. C'est une forêt primaire et secondaire de basse altitude.
                                </p>
                                <p>
