...
class Receipt
{
    ...
    function render()
    {
        ...
        <page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm">
            ...
            <table style="width:100%;padding-left:10mm;padding-right:10mm;">
                <tr style="width:100%;">
                        ...
                        <td style="width:67%;">13.50 € le 30 décembre 2018 - (Carte Bancaire)</td>
                </tr>
            </table>
        ...
        $html2pdf->output( '/Users/damienblaison/Desktop/Projet_6/Documents/Receipt/R_'.$this->content["year"].'_'.$this->content["receipt_number"].'_'.$this->content["lastname"].'_'.$this->content["firstname"].'.pdf','FI');
