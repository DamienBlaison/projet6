        ...
        if (isset($_POST)){
            ...
            (
...

                {
                    ...
                    (new \Kalaweit\Manager\Sso_token($_POST["user_login"],$token,$bdd))->add();
...
function update(){
    ...
    [
        $avatar_img = (new \Kalaweit\htmlElement\Img('/Documents/Avatar/'.$user["user_avatar"],$user["user_first_name"],'avatar_user_admin'))->render(),
